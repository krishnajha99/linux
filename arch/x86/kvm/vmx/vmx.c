...
*/
//Refactored the code for modular implementation  
...
*/	
	...
	if (vmx->emulation_required) {
	    end_time = rdtsc();
		atomic_long_add((end_time - inital_time), &AllExitsTimeCount);
		atomic_long_add((end_time - inital_time), &ExitsTimeCount[exit_reason]);
